        			...
        			<div class="box-body">
        				<form id="js-studentinfo-frm" action="" method="POST">
        					...
        					<div class="form-group">
        						...
        						<@spring.formInput "studentupdate.studentName" "id='js-name-md' class='form-control'" "text" />
        					</div>
        					<div class="form-group">
        						<label for="studentcode">Sex</label>
        						<@spring.formSexSelect "studentupdate.sex" "id='js-sex-md' class='form-control'"/>
        					</div>
        					<div class="form-group">
        						<label for="studentcode">Birthday</label>
        						<div id="js-birthday-error-md" style="color: red;"></div>
        						<@spring.formInput "studentupdate.birthday" "id='js-birthday-md' class='form-control'" "date" />
        					</div>
        				
        					<div class="form-group">
        						<label for="studentcode">School</label>
        						<@spring.formSchoolCode "studentupdate.schoolCode" schools "code" "id='js-school-md' class='form-control'" />
        					</div>
        					
        					<div class="form-group">
        						<label for="studentcode">School year</label>
        						<@spring.formYearSelect "studentupdate.schoolYear" "id='js-schoolyear-md' class='form-control'" />
        					</div>
        					
        					<div class="form-group">
        						<label for="studentcode">Phone</label>
        						<div id="js-phone-error-md" style="color: red;"></div>
        						<@spring.formInput "studentupdate.phone" "id='js-phone-md' class='form-control'" "text" />
        					</div>
        					
        					<div class="form-group">
        						<label for="studentcode">Email</label>
        						<div id="js-email-error-md" style="color: red;"></div>
        						<@spring.formInput "studentupdate.email" "id='js-email-md' class='form-control'" "text" />
        					</div>
        					
        					<div class="form-group">
        						<label for="studentcode">Address</label>
        						<@spring.formInput "studentupdate.address" "id='js-address-md' class='form-control'" "text" />
        					</div>
